...
const Categories: React.FC = () => {
    ...
    const [getProductFromCategory, { isLoading }] = useGetProductFromCategoryMutation();

    useEffect(() => {
        getProductFromCategory(slug)
            .unwrap()
            .then((fulfilled) => {
                setSelectedCategory(fulfilled);
            });
        ...
        <>
            ...
            <Container maxWidth="xl" style={{ paddingBottom: '100px' }}>
                ...
                >
                    ...
                    >
                        <h3 style={{ paddingBottom: '30px', paddingTop: '20px', fontSize: '24px', marginTop: '-60px' }}>
                            Category
                        </h3>
